...
namespace bikesSharing
{
    public class CloudInfDemo
    {
        ...
        //应用 app_key
        private static String APP_KEY = "VxHmQHW4T1LNNZ4owfBRWONMgq5iOMq3";
        //应用 app_secret
        private static String APP_SECRET = "oNUuts0Ove2bFsiBds3jzySmq19hqcKdM0YMajAxJuUzid89QY5nlvJU0Alg7su8";
